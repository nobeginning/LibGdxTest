...
public class GifDecoder {
    ...
    public Animation<TextureRegion> getAnimation(Animation.PlayMode playType) {
        ...
        Animation<TextureRegion> result = new Animation<TextureRegion>(frameDuration, texReg, playType);

        return result;
    }

    public static Animation<TextureRegion> loadGIFAnimation(Animation.PlayMode playType, InputStream is) {
        GifDecoder gdec = new GifDecoder();
        gdec.read(is);
        return gdec.getAnimation(playType);
    }

    public static Animation<TextureRegion> loadGIFAnimation(Animation.PlayMode playType, String internalPath) {
        return loadGIFAnimation(playType, Gdx.files.internal(internalPath).read());
    }
}